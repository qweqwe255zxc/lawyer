---
name: presets
description: How the preset tiers (econom/standard/premium) control visual depth — shadows, radii, card surfaces, and default section variants — via theme.preset and theme/tokens.css. Load before setting or changing theme.preset, editing depth-related tokens, or diagnosing why a "standard"-tier page looks flat instead of using cards/shadows.
---
