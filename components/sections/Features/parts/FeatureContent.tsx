...
interface FeatureContentProps {
   ...
   * (table). inline — иконка и заголовок в одну строку: для карточных
   * раскладок (cards/bento), где у иконки уже есть своя плашка и воздух
   * карточки — стек над заголовком там читается как два отдельных яруса
   * вместо одного цельного заголовка.
   */
  iconLayout?: "stack" | "inline";
  /**
   * Фото вложено в padded Card (cards/bento: p-7/md:p-9) — радиус фото
   ...
   * центр. В table карточки нет вообще — там остаётся обычный .ui-media.
   */
  mediaInset?: boolean;
  /**
